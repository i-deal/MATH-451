...
[r1, r2] = quad_roots(3,-123454321,2);
...
function [r1, r2] = quad_roots(a, b, c)
    r1 = (-b + sqrt(b^2 - 4*a*c)) / (2*a); % calculate r1 using the quadratic formula
    r2 = (-b - sqrt(b^2 - 4*a*c)) / (2*a); % calculate r2 using the quadratic formula
end